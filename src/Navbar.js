...
function Navbar() {
    ...
    return (
        <nav className=" bg-gray-800 text-white  justify-between font-bold py-4 lg:py-6 px-4">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                <h1 className="text-xl">IslamicHolidayCountdown</h1>
                ...
                <div className={`lg:flex lg:items-center space-x-6 ${isOpen ? '' : 'hidden'}`}>
                    <div className="flex flex-col lg:flex-row lg:space-x-4 lg:items-center">
                        ...
                        <Link to="/IslamicHolidayCountdown" className="py-2 lg:py-0">IslamicHolidayCountdown</Link>
